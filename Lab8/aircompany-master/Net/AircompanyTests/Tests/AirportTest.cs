...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void AirportIsHavePlaneWithMaxPassengersCapacityTest()
        {
            Airport airport = new Airport(planes);
        ...
        public void NextPlaneMaxLoadCapacityIsHigherThanCurrentTest()
        {
            ...
            Assert.Greater(airport.GetPlanes().ToList()[1].GetMaxLoadCapacity(), airport.GetPlanes().ToList()[0].GetMaxLoadCapacity());
        }
    }
}
